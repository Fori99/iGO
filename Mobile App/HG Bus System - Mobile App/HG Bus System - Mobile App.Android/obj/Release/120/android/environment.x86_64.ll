...
@__app_environment_variables_v_2.5 = internal constant [37 x i8] c"b29cf42f-34b7-4ada-a65c-ed7f19f25520\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [12 x i8] c"com.app.iGO\00", align 1
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i8* getelementptr inbounds ([12 x i8], [12 x i8]* @__ApplicationConfig_android_package_name.0, i32 0, i32 0); android_package_name
}, align 8
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [46 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
